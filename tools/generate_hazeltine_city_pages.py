...
def clean_intro(raw: str, city: str, county: str) -> str:
    ...
    if not t or re.search(
        ...
        r"\bour bay\b|bay-based|bay appointments|on the bay|schedule a bay|on-bay",
        t,
        re.I,
    ):
        return (
            f"Hazeltine is 100% mobile auto detailing in {city}, Minnesota — serving {county}. "
            f"Wash & seal from $149+, interior resets, paint enhancement, "
            f"and ceramic from $899+. We come to your driveway, workplace, or fleet lot — request a quote to book."
        )
    t = re.sub(
        r"the Twin Cities metro\s+and\s+the\s+greater\s+Twin\s+Cities",
                ...
                "mainEntity": [
                    {
                        ...
                        "acceptedAnswer": {
                            "@type": "Answer",
                            "text": (
                                f"Yes. Hazeltine is 100% mobile — we come to you in {city} and throughout {county}. "
                                "Call (763) 352-7411 or request a quote on our site."
                            ),
                        },
                    },
                    {
                    ...
                    },
                    {
                        ...
                        "acceptedAnswer": {
                            "@type": "Answer",
                            "text": (
                                "We can use your exterior spigot and standard outlets when available. If not, tell us "
                                "when you request a quote and we'll confirm what's needed before we arrive."
                            ),
                        },
                    },
                ],
...
<nav role="navigation" aria-label="Main navigation">
  ...
  <div class="nav-links">
    <div class="nav-primary" role="group" aria-label="Site sections">
      <a href="index.html#packages">Pricing</a>
      <a href="index.html#service-menu">Services</a>
    ...
    <div class="nav-actions" role="group" aria-label="Book detailing">
  ...
  <div class="hero-content">
    <div>
      ...
      <div class="hero-cta-row">
        ...
        <a href="{et}" class="btn-hero-outline" target="_blank" rel="noopener nofollow">Schedule mobile</a>
...
<section id="packages">
  <div class="section-inner">
    ...
    <div class="cta-row">
      ...
      <a href="{et}" class="btn-secondary" target="_blank" rel="noopener nofollow">Schedule mobile detail →</a>
    </div>
  </div>
</section>
...
<section>
  <div class="section-inner">
    ...
    <p class="section-subtitle">100% mobile routes across the Twin Cities — same Hazeltine process as Minneapolis &amp; St. Paul.</p>
    <div class="info-grid">
      ...
      <div class="info-card"><h3>Clear pricing</h3><p>Starting prices are listed upfront; final scope is confirmed after photos or an on-site inspection — no bait-and-switch.</p></div>
      <div class="info-card"><h3>Book your way</h3><p>Request a quote on the main site, book a mobile visit online, or call <strong>(763) 352-7411</strong>.</p></div>
    </div>
  </div>
</section>
...
<section id="book" class="cta-banner">
  ...
  <p>Request a quote for mobile detailing — wash, interior, correction, or ceramic.</p>
...
<section id="mobile-faq">
  <div class="section-inner mobile-faq-inner">
    ...
    <div class="faq-list" style="display:flex;flex-direction:column;gap:1.25rem;margin-top:1.5rem;">
      <div class="faq-simple-block"><h3>Water &amp; power?</h3><p>We can use your spigot and outlets when available; if not, we’ll note it when you book and confirm logistics before we arrive.</p></div>
...
<section id="faq" class="section-inner" style="padding:3rem 1.5rem 4rem;max-width:42rem;margin:0 auto;">
  ...
  <div class="faq-list" style="display:flex;flex-direction:column;gap:1.25rem;">
    <div class="faq-simple-block"><h3>Do you detail in {city_e}?</h3><p>Yes — we’re fully mobile across {city_e}, {county_e}, and the metro. Start with a quote on our homepage or call (763) 352-7411.</p></div>
